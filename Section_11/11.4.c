...
void analyse_hands(int num_in_rank[], int num_in_suit[], bool *straight, bool *flush, bool *four, bool *three, int *pairs);
...
int main(void){
	...
	for(;;){
		...
		analyse_hands(num_in_rank, num_in_suit, &straight, &flush, &four, &three, &pairs);
